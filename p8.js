...
export default class p8 extends React.Component {
  render() {
    return (
      <Fragment>
                  ...
                  <View style={{
                    ...
                    justifyContent: 'center',
                      ...
                      <Text style={{
                        ...
                        paddingBottom:30,
                        paddingLeft: 7
                      }}>REVIEW PAPER PRESENTATION</Text>
                    </View>
                    ...
                    <View style={{paddingBottom: 20}}>
                        ...
                        <Text style={{fontSize: 15,
                          ...
                          <Text style={{fontSize: 15,
                           ...
                           Registration Fee: 50 INR for IEEE members and 100 INR for non IEEE members
                        </Text>
                          <Text style={{fontSize: 15,
                                }}>
