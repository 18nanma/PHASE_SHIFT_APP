...
export default class e11 extends React.Component {
  render() {
    return (
      <Fragment>
                  ...
                  <View style={{
                    ...
                    <View style={{paddingBottom: 20}}>
                        ...
                        fontWeight: 'semibold',
                         ...
                         There's a few that possess the mettle and maven for a race against time. Engage on a 24 hour journey to innovate, design and discover.
                        </Text>
                        ...
                        <Text style={{fontSize: 15,
                          ...
                          <Text style={{fontSize: 15,
                           ...
                           Prize money:1st-Internship with Electrono Solutions
                        </Text>
                        <Text style={{fontSize: 15,
                            }}>
                         Date: 14/09/2019 & 15/09/2019
                          ...
                          <Text style={{fontSize: 15,
                           ...
                           Venue: Measurements lab, PG block
                        </Text>
                        </View>
                    </View>
                    <View style={{padding:7,
