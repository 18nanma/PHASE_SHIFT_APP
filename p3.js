  ...
  render() {
    return (
      ...
      <ScrollView
		 ...
		 Each team gets 15 minutes to share their ideas.
                         </Text>
	        <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>
		 Participants need to get their own laptops.
                         </Text>
	   <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>
		Topic will be given on the spot, and participants get 1 hour to prepare on the given topics.
                         </Text>
	   <Text style={{paddingBottom: 20,
                        fontSize: 15,

                      }}>
		They have to present their ideas with a PPT.
                         </Text>
                    </View>
                    </View>
                    ...
                    <View style={{padding:7,
                        ...
                        <Text style={{fontSize: 15,
                              ...
                              1.Varalakshmi K R- 9066239303
                        </Text>
                        <Text style={{fontSize: 15,

                        }}>
                              2.Vidyashree T S- 8548893504
                        </Text>
                       <Text style={{fontSize: 15,
