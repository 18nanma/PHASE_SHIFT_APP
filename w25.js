...
export default class w25 extends React.Component {
  render() {
    return (
      <Fragment>
                  ...
                  <View style={{
                    ...
                    justifyContent: 'center',
                      ...
                      <Text style={{
                        ...
                        paddingBottom:30,
                        paddingLeft: 7
                      }}>BUILDING ENERGY EFFICIENT SMART HOMES</Text>
                    </View>
...
An individual Hands on workshop conducted by resource persons from industry having more than 20 years of experience at CISCO where students will learn about energy efficiency, reliable energy efficient smart homes using packet tracer software.                        <View style={{padding:7,
                    ...
                    <View>
                        ...
                        fontSize: 15,
                      }}>The participants need to get their laptops with pre-requisite software which will be mentioned prior the event.
                         </Text>
                    </View>
                    </View>
                    ...
                    <View style={{padding:7,
                        ...
                        <Text style={{fontSize: 15,
                              ...
                              1.Anusha S - 8749090162
                        </Text>
                        <Text style={{fontSize: 15,
                          }}>
                              2.Shilpa M P - 9164231456
                        </Text>
